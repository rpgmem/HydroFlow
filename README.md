...
> Escopo explícito: simulação simplificada (**Torricelli + continuidade de volume**), **não** CFD/Navier-Stokes. Ver [Fora de escopo](#fora-de-escopo).
...
- **Check valve / registro / boia** — refluxo bloqueado; registro on/off manual; boia mecânica fecha ao encher o destino.
