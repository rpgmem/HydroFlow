...
- **[Pressão na base](https://pt.wikipedia.org/wiki/Press%C3%A3o_hidrost%C3%A1tica) (Teorema de Stevin)** — `P = ρ·g·h` (readout no inspetor do reservatório, na unidade de pressão escolhida em ⚙ Opções: kPa, m.c.a. ou psi). Só exibição — não entra no cálculo de vazão.
